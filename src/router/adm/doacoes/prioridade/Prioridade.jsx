...
const Prioridade = () => {
    ...
    const [todosProdutos] = useState(produtosEstaticos);
                    ...
                    <Grid container stackable columns={3} doubling>
                        {todosProdutos.map((produto) => (
                            <Grid.Column key={produto.id}>
                                <Card centered className={getPriorityClassBorder(produto.requirement)}>
                                    <Label className={getPriorityClassIcon(produto.requirement)} corner="right">
                                        <Icon name='star' />
                                    </Label>
                                    ...
                                    <Card.Content extra>
                                        <div className="counter-controls-prioridade">
                                            <div className={getPriorityClass(produto.requirement)}>
                                                <p>{produto.requirement}</p>
                                            </div>
                                        </div>
                                    </Card.Content>
                                </Card>
