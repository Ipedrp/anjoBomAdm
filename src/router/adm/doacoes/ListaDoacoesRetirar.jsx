...
function ListaDoacoesRetirarEstatico() {
    // Dados estáticos de exemplo
    const doacoesEstaticas = [
        {
            id: 1,
            doador: {
                name: "Maria Silva",
        ...
        },
        {
            ...
            items: {
                produtos: [
                    { name: "Macarrão", quantity: 4 },
                    { name: "Molho de Tomate", quantity: 6 },
        ...
        },
        {
            ...
            items: {
                produtos: [
                    { name: "Leite", quantity: 8 },
                    { name: "Café", quantity: 3 },
                    { name: "Biscoito", quantity: 5 }
                ]
            },
            status: "COLETADA"
        },
        {
            ...
            items: {
                produtos: [
                    { name: "Farinha de Trigo", quantity: 4 },
                    { name: "Sal", quantity: 3 },
    ...
    const [doacoes, setDoacoes] = useState(doacoesEstaticas);
    ...
    const atualizarCesta = (id) => {
        setDoacoes(doacoes.map(doacao => 
            doacao.id === id ? {...doacao, status: "COLETADA"} : doacao
        ));
...
export default ListaDoacoesRetirarEstatico;
