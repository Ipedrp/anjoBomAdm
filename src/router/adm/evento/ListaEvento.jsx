...
function ListaEvento() {
    ...
    const eventosIniciais = [
        {
            id: 1,
            titulo: "Feira de Doação de Alimentos",
            descricao: "Evento para arrecadação de alimentos não perecíveis para famílias carentes.",
            address: {
                cep: "01001-000",
                estado: "SP",
                cidade: "São Paulo",
            ...
            data_inicio: "2023-12-15T10:00:00",
            data_fim: "2023-12-15T18:00:00",
            photosUrl: [
        ...
        },
        {
            ...
            descricao: "Arrecadação de roupas de frio para moradores de rua.",
            address: {
                cep: "20010-020",
                estado: "RJ",
            ...
            data_inicio: "2023-07-20T09:00:00",
            data_fim: "2023-07-20T17:00:00",
            photosUrl: [
                "https://via.placeholder.com/150"
            ]
        },
        {
            id: 3,
            titulo: "Doação de Brinquedos",
            descricao: "Evento para arrecadar brinquedos para crianças carentes no Natal.",
            address: {
                cep: "30120-010",
                estado: "MG",
            ...
            data_inicio: "2023-12-10T08:00:00",
            data_fim: "2023-12-10T16:00:00",
            photosUrl: []
        }
    ];
    ...
    const [allEventos, setAllEventos] = useState(eventosIniciais);
    ...
    const confirmarDelecao = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                setAllEventos(allEventos.filter(evento => evento.id !== id));
                Swal.fire({
                    icon: 'success',
                    title: 'Deletado!',
    ...
    const verMais = (id) => {
        const evento = allEventos.find((evento) => evento.id === id);
    ...
    const enviarEdicao = async () => {
        ...
        const eventoAtualizado = {
            ...eventoParaEditar,
            titulo: formCriarEvento.titulo,
            descricao: formCriarEvento.descricao,
            address: formCriarEvento.address,
            data_inicio: formCriarEvento.data_inicio,
            data_fim: formCriarEvento.data_fim,
            photosUrl: existingPhotos
        };

        setAllEventos(allEventos.map(evento =>
            evento.id === eventoParaEditar.id ? eventoAtualizado : evento
        ));
                        ...
                        <div className="input-area-criarEvento">
                            <Form>
                                <FormInput
                                    ...
                                    maxLength={100}
                                    minLength={10}
                                    error={erros.titulo ? { content: erros.titulo } : undefined}
                                    onChange={(e) => {
                                ...
                                <FormGroup widths="equal">
                                    <FormInput
                                        ...
                                        value={formCriarEvento.data_inicio ? new Date(formCriarEvento.data_inicio).toISOString().slice(0, 10) : ''}
                                        error={erros.data_inicio ? { content: erros.data_inicio } : undefined}
                                        onChange={(e) => {
                                    ...
                                    <FormInput
                                        ...
                                        value={formCriarEvento.data_fim ? new Date(formCriarEvento.data_fim).toISOString().slice(0, 10) : ''}
                                        error={erros.data_fim ? { content: erros.data_fim } : undefined}
                                        onChange={(e) => {
                                ...
                                <FormInput
                                    ...
                                    control={TextArea}
                                    style={{ resize: "none" }}
                                    error={erros.descricao ? { content: erros.descricao } : undefined}
                                    onChange={(e) => {
