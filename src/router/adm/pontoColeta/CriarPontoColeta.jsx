...
const CriarPontoColeta = () => {
    ...
    const validateCep = async (value) => {
        ...
        // Verifica se o CEP está na lista de CEPs válidos simulados
    ...
    const handleChange = async (e) => {
        ...
        setErros(prev => {
            ...
            switch (name) {
                case "name":
                    newErros.name = value.length > 99 ? "Máximo 100 caracteres" : "";
                    break;
                case "urlMap":
                    newErros.urlMap = value.length > 499 ? "Máximo 500 caracteres" : "";
                    break;
                case "address.cep":
    ...
    const EnviarPontoColeta = async () => {
        ...
        Swal.fire({
            title: "Sucesso!",
            text: "O ponto de coleta foi criado (simulação)!",
            icon: "success",
            timer: 1300,
        ...
        // Navega para a lista de pontos de coleta
        navigate("/listaPontoColeta");
    };
